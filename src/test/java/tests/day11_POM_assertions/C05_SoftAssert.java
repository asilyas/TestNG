...
public class C05_SoftAssert {
    ...
    public void amazonTesti(){
        ...
        softAssert.assertTrue(actualAramaSonucYazisi.contains(expectedIcerik),"arama sonucu Nutella içermiyor");
        ...
        softAssert.assertTrue(actualIlkUrunIsim.contains(expectedIcerik),"ilk ürün ismi Nutella içermiyor");
